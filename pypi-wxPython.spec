...
License  : BSD-3-Clause BSL-1.0 GPL-2.0 GPL-3.0 HPND LGPL-2.0 Libpng MIT TCL Zlib libtiff wxWindows
Requires: pypi-wxPython-bin = %{version}-%{release}
Requires: pypi-wxPython-filemap = %{version}-%{release}
Requires: pypi-wxPython-lib = %{version}-%{release}
...
%package filemap
Summary: filemap components for the pypi-wxPython package.
Group: Default

%description filemap
filemap components for the pypi-wxPython package.


%package lib
Summary: lib components for the pypi-wxPython package.
Group: Libraries
Requires: pypi-wxPython-license = %{version}-%{release}
Requires: pypi-wxPython-filemap = %{version}-%{release}

%description lib
lib components for the pypi-wxPython package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679942122
...
%files filemap
%defattr(-,root,root,-)
/usr/share/clear/filemap/filemap-pypi-wxPython
